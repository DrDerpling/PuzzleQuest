                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            @elseif($game->userSolvedPhase($name) && $game->currentPhase === 3)
                                <p style="font-size: 12px">{!! $player['questions'][1]['question'] !!}
                                    <br> {{$player['questions'][1]['answers'][0]}}</p>
                                <i style="color: green" class="large material-icons">check</i>
                                <p>Opgelost</p>
                            @else
        ...
        <div class="row">
            <form method="post" action="{{route('verify')}}">
                ...
                <div class="row phase-final">
                    ...
                    <div class="input-field col right-align s4 m2">
